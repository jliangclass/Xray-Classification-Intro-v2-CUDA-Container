#!/usr/bin/env bash
#SBATCH --job-name=mimic-convnext-adamw-best
...
# ./apptainer-run-mimic-convnext-base-best.sh dataset.dataset_root=$XRAY_DATASET
# ./apptainer-run-mimic-convnext-base-best.sh debug=True dataset.dataset_root=$XRAY_DATASET train.batch_size=128
