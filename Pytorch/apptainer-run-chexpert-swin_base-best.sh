#!/usr/bin/env bash
#SBATCH --job-name=chexpert-convnext-adam
...
# ./apptainer-run-chexpert-swin_base-best.sh dataset.dataset_root=$XRAY_DATASET
# ./apptainer-run-chexpert-swin_base-best.sh debug=True dataset.dataset_root=$XRAY_DATASET train.batch_size=128
