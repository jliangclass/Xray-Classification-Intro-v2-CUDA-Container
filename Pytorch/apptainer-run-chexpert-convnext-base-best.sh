#!/usr/bin/env bash
#SBATCH --job-name=chexpert-convnext-adamw-best
...
# ./apptainer-run-chexpert-convnext-base-best.sh dataset.dataset_root=$XRAY_DATASET
# ./apptainer-run-chexpert-convnext-base-best.sh debug=True dataset.dataset_root=$XRAY_DATASET train.batch_size=128
