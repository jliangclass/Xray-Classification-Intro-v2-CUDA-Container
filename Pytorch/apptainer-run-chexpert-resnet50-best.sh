#!/usr/bin/env bash
#SBATCH --job-name=chexpert-resnet50-adam
...
# ./apptainer-run-chexpert-resnet50-best.sh dataset.dataset_root=$XRAY_DATASET
# ./apptainer-run-chexpert-resnet50-best.sh debug=True dataset.dataset_root=$XRAY_DATASET train.batch_size=128
