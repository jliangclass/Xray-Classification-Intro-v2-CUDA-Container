#!/usr/bin/env bash
#SBATCH --job-name=mimic-resnet50-adam
...
# ./apptainer-run-mimic-resnet50-best.sh dataset.dataset_root=$XRAY_DATASET
# ./apptainer-run-mimic-resnet50-best.sh debug=True dataset.dataset_root=$XRAY_DATASET train.batch_size=128
